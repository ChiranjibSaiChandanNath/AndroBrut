...
def startup_animation():
 ...
 ______  __  __  ____    ____    _____   ____     ____    __  __  ______   
/\  _  \/\ \/\ \/\  _`\ /\  _`\ /\  __`\/\  _`\  /\  _`\ /\ \/\ \/\__  _\  
\ \ \L\ \ \ `\\ \ \ \/\ \ \ \L\ \ \ \/\ \ \ \L\ \\ \ \L\ \ \ \ \ \/_/\ \/  
 \ \  __ \ \ , ` \ \ \ \ \ \ ,  /\ \ \ \ \ \  _ <'\ \ ,  /\ \ \ \ \ \ \  
  \ \ \/\ \ \ \`\ \ \ \_\ \ \ \\ \\ \ \_\ \ \ \L\ \\ \ \\ \\ \ \_\ \ \ \ \ 
   \ \_\ \_\ \_\ \_\ \____/\ \_\ \_\ \_____\ \____/ \ \_\ \_\ \_____\ \ \_\

    \/_/\/_/\/_/\/_/\/___/  \/_/\/ /\/_____/\/___/   \/_/\/ /\/_____/  \/_/
  ...
  \ \ \/\ \ \ \`\ \ \ \_\ \ \ \\ \\ \ \_\ \ \ \L\ \\ \ \\ \\ \ \_\ \ \ \ \ 
   \ \_\ \_\ \_\ \_\ \____/\ \_\ \_\ \_____\ \____/ \ \_\ \_\ \_____\ \ \_\
    ...
    \/_/\/_/\/_/\/_/\/___/  \/_/\/ /\/_____/\/___/   \/_/\/ /\/_____/  \/_/
          ...
          Made with ❤️ by Andro                                     
\033[0m
"""
    tagline = "Android Security Automation | v1.0"
    if colored:
...
def initial_environment_check():
    os.system('cls' if os.name == 'nt' else 'clear')
    print("\033[1;36m→ Verifying AndroBrut Environment...\033[0m\n")
    checks = [
...
def get_install_prompt(check_name):
    ...
    return prompts.get(check_name, "Follow the AndroBrut documentation for setup instructions.")
...
def show_virtual_device_instructions():
    ...
    print("\033[1;36mAndroBrut guides you, but YOU MUST perform these steps in Android Studio.\033[0m\n")
...
def install_magisk_and_patch_rootavd():
    ...
    print("\033[1;33mAndroBrut automates downloads and patching, but YOU MUST perform manual steps to complete rooting.\033[0m\n")
...
def display_main_menu():
    while True:
        ...
        if choice == "1":
            ...
            os.system('cls' if os.name == 'nt' else 'clear')
            print("\033[92m✔ Exiting AndroBrut. Stay sharp!\033[0m")
            break
